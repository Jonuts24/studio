...
import { Compass, ShieldCheck, Map, Trophy, LayoutDashboard } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen pb-24 selection:bg-accent/30">
      {/* Header section */}
      <header className="relative py-20 px-6 border-b border-border bg-[url('https://picsum.photos/seed/bg-wt-hangar/1920/600')] bg-cover bg-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="text-center md:text-left space-y-6 flex-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 border border-accent/20 text-accent text-sm font-medium">
              ...
              <span>Comprehensive Rank I-VIII Coverage</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl font-body leading-relaxed">
              Master the grind for all 10 major nations. From the first biplane to the latest main battle tanks, we provide the ultimate research path for every rank.
            </p>
        ...
        <div className="flex flex-col gap-12">
          ...
          <div>
            <div className="mb-8 space-y-2">
              ...
              <p className="text-muted-foreground">Explore the progression paths for all 10 major powers in War Thunder.</p>
            </div>
            <NationSelector 
      ...
      <footer className="mt-24 py-12 border-t border-border bg-card">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="text-sm text-muted-foreground text-center md:text-right">
            ...
            <p className="mt-1">Covering USA, Germany, USSR, Britain, Japan, China, Italy, France, Sweden, and Israel.</p>
          </div>
        </div>
      </footer>
    </main>
